...
Dijkstra-based congestion-aware pathfinding
ML-driven queue time prediction
...
Built using modern technologies like React, Node.js, Kafka, and AI/ML models, the system provides live crowd insights, predictive analytics, and smart navigation for large-scale venues.
